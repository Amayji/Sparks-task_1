...
<body style="background-image:url('statics/5570834-min.jpg'); padding-top:2%;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/Amay.jpg" alt="" style="width:20%;  box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Amay sharma</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> TCET, Mumbai</b></p>
    </center>
